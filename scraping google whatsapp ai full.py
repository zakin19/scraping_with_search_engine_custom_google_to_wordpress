...
query = ['trend whatsapp ai','whatsapp ai features','whatsapp ai news','ai on whatsapp','article whatsapp ai'] #list keyword
...
def full_scraping():
    ...
    print("\nHasil gen prompt image : ", hasil)  # Ini akan dicetak setelah berhasil atau setelah 5 percobaan
